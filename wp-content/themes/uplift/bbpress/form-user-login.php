...
<form method="post" action="<?php bbp_wp_login_action( array( 'context' => 'login_post' ) ); ?>" class="bbp-login-form">
	<fieldset class="bbp-form">
		<legend><?php _e( 'Log In', 'uplift' ); ?></legend>
		...
		<div class="bbp-password">
			<label for="user_pass"><?php _e( 'Password', 'uplift' ); ?>: </label>
		...
		<div class="bbp-remember-me">
			...
			<label for="rememberme"><?php _e( 'Keep me signed in', 'uplift' ); ?></label>
		</div>
		...
		<div class="bbp-submit-wrapper">
			...
			<button type="submit" tabindex="<?php bbp_tab_index(); ?>" name="user-submit" class="button submit user-submit"><?php _e( 'Log In', 'uplift' ); ?></button>
