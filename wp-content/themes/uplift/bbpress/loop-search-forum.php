...
<div class="bbp-forum-header">
	...
	<div class="bbp-meta">
		...
		<span class="bbp-forum-post-date"><?php printf( __( 'Last updated %s', 'uplift' ), bbp_get_forum_last_active_time() ); ?></span>
	...
	<div class="bbp-forum-title">
		...
		<h3><?php _e( 'Forum: ', 'uplift' ); ?><a href="<?php bbp_forum_permalink(); ?>"><?php bbp_forum_title(); ?></a></h3>
