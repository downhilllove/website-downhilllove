    ...
    */
        ...
        function sf_mini_product_items( $asset_type, $category, $item_count, $sidebar_config, $width ) {
            ...
            if ( $asset_type == "latest-products" ) {
                ...
                if ( empty( $viewed_products ) ) {
                    return '<p class="no-products">' . __( 'You haven\'t viewed any products yet.', 'uplift' ) . '</p>';
                }
                ...
                while ( $products->have_posts() ) : $products->the_post();
                    ...
                    if ( comments_open() ) {
                        ...
                        if ( $count > 0 ) {
                            ...
                            $rating_output = '<div class="star-rating" title="' . sprintf( __( 'Rated %s out of 5', 'uplift' ), $average ) . '" itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating"><span style="width:' . ( $average * 16 ) . 'px"><span itemprop="ratingValue" class="rating">' . $average . '</span> ' . __( 'out of 5', 'uplift' ) . '</span></div>';
    ...
    if ( ! function_exists( 'sf_product_items' ) ) {
        function sf_product_items( $atts ) {
            ...
            global $woocommerce, $woocommerce_loop, $sf_product_multimasonry, $sf_product_display_layout;
			...
			if ( $multi_masonry == "yes" ) {
                ...
                sf_set_product_multimasonry(true);
            }
        		...
        		if ( $product_categories ) {
        			...
        			if ( $carousel == "yes" ) { ?>
	                    ...
	                    <div class="product-carousel carousel-wrap <?php echo $list_class; ?>">
	                        ...
	                        <ul class="products list-<?php echo $asset_type; ?> carousel-items gutters" id="carousel-<?php echo $sf_carouselID; ?>" data-columns="<?php echo esc_attr($columns); ?>" data-autoplay="">
            ...
            if ( $asset_type == "latest-products" ) {
                ...
                // If no data, quit
                if ( empty( $viewed_products ) ) {
                    return '<p class="no-products">' . __( "No products found, please add some through your WordPress admin.", 'uplift' ) . '</p>';
                }
            ...
            if ( $products->have_posts() ) {
                ...
                <?php if ( $carousel == "yes" ) { ?>
                    ...
                    <div class="product-carousel carousel-wrap <?php echo $list_class; ?>">
                        ...
                        <ul class="products list-<?php echo $asset_type; ?> carousel-items gutters" id="carousel-<?php echo $sf_carouselID; ?>" data-columns="<?php echo esc_attr($columns); ?>">
