<?php
    ...
    */
            ...
            <div class="comment-wrap clearfix">
                <div class="comment-avatar">
                    ...
                    <?php if ( $comment->comment_author_email == get_the_author_meta( 'email' ) ) { ?>
                        <span class="tooltip"><?php _e( 'Author', 'uplift' ); ?>
    ...
    <li id="comment-<?php comment_ID() ?>" <?php comment_class() ?>>
        <div class="comment-author"><?php printf( __( 'By %1$s on %2$s at %3$s', 'uplift' ),
                get_comment_author_link(),
                get_comment_date(),
                get_comment_time() );
                edit_comment_link( __( 'Edit', 'uplift' ), ' <span class="meta-sep">|</span> <span class="edit-link">', '</span>' ); ?></div>
