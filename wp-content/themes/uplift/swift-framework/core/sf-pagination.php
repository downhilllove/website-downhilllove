    ...
    */
    ...
    if ( ! function_exists( 'pagenavi' ) ) {
        function pagenavi( $query, $before = '', $after = '' ) {
            ...
            $pagenavi_options['first_text']                   = __( 'First Page', 'uplift' );
            $pagenavi_options['last_text']                    = __( 'Last Page', 'uplift' );
            $pagenavi_options['next_text']                    = apply_filters( 'sf_pagination_next_text', __( 'Next <i class="ss-navigateright"></i>', 'uplift' ) );
            $pagenavi_options['prev_text']                    = apply_filters( 'sf_pagination_prev_text', __( '<i class="ss-navigateleft"></i> Previous', 'uplift' ) );
