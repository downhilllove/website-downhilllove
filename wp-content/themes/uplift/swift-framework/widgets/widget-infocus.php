    ...
    */
    ...
    class sf_infocus extends WP_Widget {
                ...
                <div class="infocus-title clearfix">
	                ...
	                <?php if ( sf_theme_opts_name() == "sf_atelier_options" ) { ?>
						...
						<h4><a href="<?php echo esc_url($post_permalink); ?>"
                           title="<?php echo esc_attr($post_title); ?>"><?php echo $post_title; ?></a></h4>

					<?php } else if ( sf_theme_opts_name() == "sf_uplift_options" ) { ?>
						
						<h5><a href="<?php echo esc_url($post_permalink); ?>"
						   title="<?php echo esc_attr($post_title); ?>"><?php echo $post_title; ?></a></h5>
        ...
        function form( $instance ) {
            ...
            <p>
                <label
                    for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php echo __( 'Title:', 'uplift' ); ?></label>
            ...
            <p>
                <label
                    for="<?php echo esc_attr($this->get_field_id( 'post_id' )); ?>"><?php echo __( 'Post ID:', 'uplift' ); ?></label>
