<?php
    ...
    class lip_most_loved_widget extends WP_Widget {
        ...
        function __construct() {
            parent::__construct( false, $name = __( 'Most Loved Items', 'uplift' ), array( 'description' => __( 'Show the most loved items', 'uplift' ) ) );
        }
                ...
                <?php
                    ...
                    foreach ( $most_loved as $loved ) : ?>
                        ...
                        <li class="loved-item">
                            ...
                            <span><?php echo sprintf( __( 'By %1$s', 'uplift' ), $author_name ); ?></span>
        ...
        function form( $instance ) {
            ...
            ?>
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php _e( 'Title:', 'uplift' ); ?></label>
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"
                       name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" type="text"
                       value="<?php echo esc_attr($title); ?>"/>
            </p>
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'number' )); ?>"><?php _e( 'Number to Show:', 'uplift' ); ?></label>
