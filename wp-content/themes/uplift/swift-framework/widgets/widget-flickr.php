    ...
    */
    ...
    class sf_flickr_widget extends WP_Widget {
        ...
        function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'flickr_id' )); ?>"><?php _e( 'Flickr ID', 'uplift' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'number' )); ?>"><?php _e( 'Number of Photos', 'uplift' ); ?>:</label>
