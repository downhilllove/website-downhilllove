    ...
    */
    ...
    class sf_advert_grid_widget extends WP_Widget {
        ...
        function form( $instance ) {
            ...
            <p>
                <label><?php _e( 'Image 1 Link', 'uplift' ); ?>:</label>
            ...
            <p>
                <label><?php _e( 'Image 2 URL', 'uplift' ); ?>:</label>
            ...
            <p>
                <label><?php _e( 'Image 2 Link', 'uplift' ); ?>:</label>
            ...
            <p>
                <label><?php _e( 'Image 3 URL', 'uplift' ); ?>:</label>
            ...
            <p>
                <label><?php _e( 'Image 3 Link', 'uplift' ); ?>:</label>
            ...
            <p>
                <label><?php _e( 'Image 4 URL', 'uplift' ); ?>:</label>
            ...
            <p>
                <label><?php _e( 'Image 4 Link', 'uplift' ); ?>:</label>
            ...
            <p>
                <label><?php _e( 'Image 5 URL', 'uplift' ); ?>:</label>
            ...
            <p>
                <label><?php _e( 'Image 5 Link', 'uplift' ); ?>:</label>
            ...
            <p>
                <label><?php _e( 'Image 6 URL', 'uplift' ); ?>:</label>
            ...
            <p>
                <label><?php _e( 'Image 6 Link', 'uplift' ); ?>:</label>
            ...
            <p>
                <label><?php _e( 'Image 7 URL', 'uplift' ); ?>:</label>
            ...
            <p>
                <label><?php _e( 'Image 7 Link', 'uplift' ); ?>:</label>
            ...
            <p>
                <label><?php _e( 'Image 8 URL', 'uplift' ); ?>:</label>
            ...
            <p>
                <label><?php _e( 'Image 8 Link', 'uplift' ); ?>:</label>
