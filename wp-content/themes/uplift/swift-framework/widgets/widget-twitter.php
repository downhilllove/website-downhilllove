    ...
    */
    ...
    class Twitter_Widget extends WP_Widget {
        ...
        function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'username' )); ?>"><?php _e( 'Your Twitter username:', 'uplift' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'posts' )); ?>"><?php _e( 'Display how many tweets?', 'uplift' ); ?></label>
