...
<form class="variations_form cart" method="post" enctype='multipart/form-data' data-product_id="<?php echo absint( $product_id ); ?>" data-product_variations="<?php echo htmlspecialchars( json_encode( $available_variations ) ) ?>">
	...
	<?php if ( empty( $available_variations ) && false !== $available_variations ) : ?>
		<p class="stock out-of-stock"><?php _e( 'This product is currently out of stock and unavailable.', 'uplift' ); ?></p>
	<?php else : ?>
			...
			<tbody>
				<?php foreach ( $attributes as $attribute_name => $options ) : ?>
					<tr>
						...
						<td class="value">
							<?php
								$default_name = wc_sanitize_taxonomy_name( str_replace( 'pa_', '', $attribute_name ) );
								...
								echo end( $attribute_keys ) === $attribute_name ? '<a class="reset_variations" href="#">' . __( 'Clear selection', 'uplift' ) . '</a>' : '';
							?>
						</td>
					</tr>
		        <?php endforeach;?>
