...
<div class="woocommerce-count-wrap">
    <p class="woocommerce-result-count">
        <?php
            ...
            if ( 1 == $total ) {
                echo __( 'Showing the single product', 'uplift' );
            } elseif ( $total <= $per_page ) {
                printf( __( 'Showing all %d products', 'uplift' ), $total );
            } else {
                printf( __( 'Showing %1$d-%2$d of %3$d products', 'uplift' ), $first, $last, $total );
            }
        ?>
    </p>
    <p class="woocommerce-show-products">
        ...
        <a class="show-products-link"
           href="?show_products=<?php echo esc_attr($products_per_page); ?>"><?php echo esc_attr($products_per_page); ?></a>/<a
            ...
            class="show-products-link"
            href="?show_products=<?php echo esc_attr($total); ?>"><?php _e( 'All', 'uplift' ); ?></a>
    </p>
</div>