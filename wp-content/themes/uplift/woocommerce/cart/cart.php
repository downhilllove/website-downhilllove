				...
				<table class="shop_table cart" cellspacing="0">
					<thead>
						<tr>
							...
							<th class="product-name"><?php _e( 'Description', 'uplift' ); ?></th>
							<th class="product-price"><?php _e( 'Unit Price', 'uplift' ); ?></th>
							<th class="product-quantity"><?php _e( 'Quantity', 'uplift' ); ?></th>
							<th class="product-subtotal"><?php _e( 'Subtotal', 'uplift' ); ?></th>
										...
										<?php
											...
											echo WC()->cart->get_item_data( $cart_item );
				               				...
				               				if ( $_product->backorders_require_notification() && $_product->is_on_backorder( $cart_item['quantity'] ) )
				               					echo '<p class="backorder_notification">' . __( 'Available on backorder', 'uplift' ) . '</p>';
										?>
									</td>
...
								</tr>
							...
							<td colspan="6" class="actions">
								...
								<?php if ( WC()->cart->coupons_enabled() ) { ?>
									<div class="coupon-input">
										<input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php _e( 'Coupon code', 'uplift' ); ?>" />
									</div>	
									<input type="submit" class="button" name="apply_coupon" value="<?php _e( 'Apply Coupon', 'uplift' ); ?>" />
									<?php do_action( 'woocommerce_cart_coupon' ); ?>
								<?php } ?>

								<input type="submit" class="button" name="update_cart" value="<?php _e( 'Update Cart', 'uplift' ); ?>" />
			...
			<div class="col-sm-3 cart-totals-wrap">
				...
				<h3 class="bag-totals"><?php _e('Cart Totals', 'uplift');?></h3>
