	  ...
	  ?>
		<div class="sf-about-wrap">
			...
			<div class="about-content">
				...
				<h3>Latest Update (v2.5.32)</h3>
				<p></p>
				<ul>
					<li>FRONTEND: Adjusted AJAX team panel image handling, radius is now on a wrapper to allow for non-square images</li>
					<li>FRONTEND: Other fixes</li>
				</ul>
				<div class="divide"></div>
				<h3>Previous Update (v2.5.30)</h3>
				<p></p>
				<ul>
